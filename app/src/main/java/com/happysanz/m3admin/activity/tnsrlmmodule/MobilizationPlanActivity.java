...
public class MobilizationPlanActivity extends AppCompatActivity implements View.OnClickListener, IServiceListener, DialogClickListener, AdapterView.OnItemClickListener {
...
//                    progressDialogHelper.hideProgressDialog();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(this, ProjectPlanActivity.class);
