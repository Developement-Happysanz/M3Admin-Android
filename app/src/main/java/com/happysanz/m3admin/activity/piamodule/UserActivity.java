...
public class UserActivity extends AppCompatActivity implements IServiceListener, DialogClickListener, AdapterView.OnItemClickListener {
...
//            classTestArrayList.clear();
    ...
    private class HttpAsyncTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... urls) {
            ...
            progressDialogHelper.showProgressDialog(getString(R.string.progress_loading));
            String url = M3AdminConstants.BUILD_URL + M3AdminConstants.USER_LIST;
