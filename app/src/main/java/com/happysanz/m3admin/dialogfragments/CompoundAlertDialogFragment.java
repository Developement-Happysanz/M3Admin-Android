...
public class CompoundAlertDialogFragment extends DialogFragment {
    ...
    public static CompoundAlertDialogFragment newInstance(String title, String message, String posButton, String negButton, int tag) {
        ...
        args.putString(M3AdminConstants.ALERT_DIALOG_TITLE, title);
        args.putString(M3AdminConstants.ALERT_DIALOG_MESSAGE, message);
        args.putString(M3AdminConstants.ALERT_DIALOG_POS_BUTTON, posButton);
        args.putString(M3AdminConstants.ALERT_DIALOG_NEG_BUTTON, negButton);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        String title = args.getString(M3AdminConstants.ALERT_DIALOG_TITLE);
        tag = args.getInt(M3AdminConstants.ALERT_DIALOG_TAG, 0);
        String posButton = args.getString(M3AdminConstants.ALERT_DIALOG_POS_BUTTON, getActivity().getString(R.string.alert_button_ok));
        String negButton = args.getString(M3AdminConstants.ALERT_DIALOG_NEG_BUTTON, getActivity().getString(R.string.alert_button_cancel));
