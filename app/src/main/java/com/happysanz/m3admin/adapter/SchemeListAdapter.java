...
public class SchemeListAdapter extends BaseAdapter {
    ...
    private ArrayList<Scheme> mobilizers;
    private boolean mSearching = false;
    private boolean mAnimateSearch = false;
    private ArrayList<Integer> mValidSearchIndices = new ArrayList<Integer>();

    public SchemeListAdapter(Context context, ArrayList<Scheme> mobilizers) {
...
//                .build();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder = (SchemeListAdapter.ViewHolder) convertView.getTag();
        ...
        holder.txtPiaName.setText(mobilizers.get(position).getscheme_name());
    ...
    public void startSearch(String eventName) {
        ...
        for (int i = 0; i < mobilizers.size(); i++) {
            String homeWorkTitle = mobilizers.get(i).getscheme_name();
