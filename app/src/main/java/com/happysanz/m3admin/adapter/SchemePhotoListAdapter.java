...
public class SchemePhotoListAdapter  extends BaseAdapter {

    //    private final Transformation transformation;
    private static final String TAG = CenterPhotosListAdapter.class.getName();
    private final Transformation transformation;
    private Context context;
    private ArrayList<SchemePhoto> centerPhotosData;
    ...
    public SchemePhotoListAdapter(Context context, ArrayList<SchemePhoto> centerPhotosData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SchemePhoto centerPhotosDatas = centerPhotosData.get(position);
